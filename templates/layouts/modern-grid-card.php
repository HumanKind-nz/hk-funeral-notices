...
<article class="hkfn-enhancement-modern-card">
    <a href="<?php echo esc_url(get_permalink($post_id)); ?>" class="hkfn-enhancement-modern-link">

        <?php if ($image_url): ?>
            <div class="hkfn-enhancement-modern-image">
                <img src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($full_name); ?>" loading="lazy">
            </div>
        <?php endif; ?>

        <div class="hkfn-enhancement-modern-content">
            ...
            <h3 class="hkfn-enhancement-modern-title"><?php echo esc_html($full_name); ?></h3>

            <?php if ($years_display): ?>
                <p class="hkfn-enhancement-modern-dates"><?php echo esc_html($years_display); ?></p>
            <?php endif; ?>

            <?php if ($funeral_date && !$hide_details): ?>
                <div class="hkfn-enhancement-modern-service">
                    <span class="hkfn-service-info">
                    ...
                    <?php if ($streaming['is_public'] && !empty($streaming['streaming_url'])): ?>
                        <span class="hkfn-streaming-icon" title="Live streaming available">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path d="M0 256a256 256 0 1 1 512 0 256 256 0 1 1 -512 0zm128-64l0 128c0 17.7 14.3 32 32 32l128 0c17.7 0 32-14.3 32-32l0-40 80 40 0-128-80 40 0-40c0-17.7-14.3-32-32-32l-128 0c-17.7 0-32 14.3-32 32z"/>
                            </svg>
                        </span>
