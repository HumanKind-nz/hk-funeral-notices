...
<?php if ($mode === 'current'): ?>
    ...
    <div class="hkfn-current-service-info">
        <div class="hkfn-current-service-details">
...
<?php else: ?>
    ...
    <div class="hkfn-service-documents hkfn-<?php echo esc_attr($mode); ?>-service-documents">
        <?php if ($mode === 'elegant'): ?>
            <h2 class="hkfn-elegant-section-title">Service Documents</h2>
        <?php else: // modern and default ?>
            <h2 class="hkfn-modern-section-title">Service Documents</h2>
        <?php endif; ?>
<?php endif; ?>
    ...
    <?php else: ?>
        ...
        <div class="hkfn-documents-list hkfn-<?php echo esc_attr($mode); ?>-documents-list">
            <?php if ($service_sheet): ?>
                <div class="hkfn-document-item hkfn-<?php echo esc_attr($mode); ?>-document-item">
                    <div class="hkfn-document-info hkfn-<?php echo esc_attr($mode); ?>-document-info">
                        <h3 class="hkfn-document-title hkfn-<?php echo esc_attr($mode); ?>-document-title">Service Sheet</h3>
                        <p class="hkfn-document-description hkfn-<?php echo esc_attr($mode); ?>-document-description">Order of service and program details</p>
                    </div>
                    <div class="hkfn-document-actions hkfn-<?php echo esc_attr($mode); ?>-document-actions">
                        <a href="<?php echo esc_url($service_sheet['url']); ?>"
                           target="_blank"
                           rel="noopener"
            ...
            <?php if ($has_video): ?>
                <div class="hkfn-document-item hkfn-<?php echo esc_attr($mode); ?>-document-item hkfn-video-item">
                    <div class="hkfn-document-info hkfn-<?php echo esc_attr($mode); ?>-document-info">
                        <h3 class="hkfn-document-title hkfn-<?php echo esc_attr($mode); ?>-document-title">Memorial Video Slideshow</h3>
                        <p class="hkfn-document-description hkfn-<?php echo esc_attr($mode); ?>-document-description">Watch the memorial video tribute</p>
                    </div>
                    <div class="hkfn-document-actions hkfn-<?php echo esc_attr($mode); ?>-document-actions">
                        <a href="<?php echo esc_url($video_data['stream_url'] ?? ''); ?>"
                           target="_blank"
                           rel="noopener"
                           class="hkfn-download-button hkfn-<?php echo esc_attr($mode); ?>-download-button hkfn-video-button">
                           📹 Watch Memorial Video
                        </a>
                    </div>
                </div>
            ...
            <?php if (!empty($additional_docs)): ?>
                <?php foreach ($additional_docs as $doc): ?>
                    <?php if (!empty($doc['file'])): ?>
                        <div class="hkfn-document-item hkfn-<?php echo esc_attr($mode); ?>-document-item">
                            <div class="hkfn-document-info hkfn-<?php echo esc_attr($mode); ?>-document-info">
                                <h3 class="hkfn-document-title hkfn-<?php echo esc_attr($mode); ?>-document-title">
                                    <?php echo esc_html($doc['title'] ?: 'Additional Document'); ?>
                                </h3>
                                <?php if (!empty($doc['file']['filename'])): ?>
                                    <p class="hkfn-document-filename hkfn-<?php echo esc_attr($mode); ?>-document-filename"><?php echo esc_html($doc['file']['filename']); ?></p>
                                <?php endif; ?>
                            </div>
                            <div class="hkfn-document-actions hkfn-<?php echo esc_attr($mode); ?>-document-actions">
                                <a href="<?php echo esc_url($doc['file']['url']); ?>" 
